...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="bg-navy text-white pt-12 pb-4 border-t border-gray-700">
        <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 className="text-xl font-bold text-gold mb-4 font-serif-en">CLEOPATRA HOLIDAYS</h3>
                    <p className="text-gray-400">Your journey of a lifetime starts here. Experience the world in luxury with our bespoke travel services.</p>
                </div>
                <div>
                    <h4 className="text-lg font-bold mb-4">{t('navbar.quick_links')}</h4>
                    <ul className="space-y-2">
                        <li><Link to="/" className="text-gray-400 hover:text-gold transition-colors">{t('navbar.home')}</Link></li>
                ...
                <div>
                    <h4 className="text-lg font-bold mb-4">{t('contact.info_title')}</h4>
                ...
                <div>
                    ...
                    <div className="flex space-x-4">
                        <a href="https://www.facebook.com/profile.php?id=61578031546768" className="text-gray-400 hover:text-gold transition-colors">
                            <span className="sr-only">Facebook</span>
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/cleopatraholidays" className="text-gray-400 hover:text-gold transition-colors">
                        ...
                        <a href="https://www.tiktok.com/@cleopatraholidays" className="text-gray-400 hover:text-gold transition-colors">
                            <span className="sr-only">Tiktok</span>
                            <TiktokIcon className="h-6 w-6" fill="currentColor"/>
                        </a>
                    </div>
                </div>
            </div>
            <div className="border-t border-gray-700 mt-4 pt-4 text-center text-gray-400">
                <p>&copy; {new Date().getFullYear()} Cleopatra Holidays. {t('footer.rights')}</p>
            </div>
        </div>
    </footer>
    );
